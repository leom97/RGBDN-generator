...
int main()
{
    ...
    // -------------------------
    Shader ourShader("../Data/shaders/model_loading.vert", "../Data/shaders/model_loading.frag");
    ...
    ourShader.use();
    ourShader.setVec3("light.wDir", lightDir);
    ourShader.setVec3("light.color", lightCol);
