...
int main()
{
	...
	glShaderSource(fragmentShaderId2, 1, &fragmentShaderSource2, NULL);
	...
	unsigned int shaderFlow2{ glCreateProgram() };
	glAttachShader(shaderFlow2, vertexShaderId);
	glAttachShader(shaderFlow2, fragmentShaderId2);
	glLinkProgram(shaderFlow2);
